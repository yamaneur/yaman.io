...
const items = [
  {
    ...
    type: "كتاب",
    title: "الريال الأول",
    description: "ثلاث خطوات للتحقق بكفاءة من مشروعك الريادي من تجارب عشرة سنوات",
    publisher: "دار تشكيل",
  ...
  },
  {
    ...
    description: "عشرة مفاهيم تساعدك تبني منتجات تفهم الإنسان وكيف يفكّر ويتخد قراراته",
  ...
  },
  {
    ...
    type: "أداة",
    title: "تجريب",
    description: "أداة تجهّزلك خطة تحقق لمشروعك الريادي في الميدان مع عملاء حقيقيين",
