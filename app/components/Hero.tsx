...
const tags = [
  { label: "ثمانية", href: "#experience" },
  { label: "لاندسكيب", href: "#experience" },
  { label: "ويبوك", href: "#experience" },
  { label: "السعودية", href: "#" },
];
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28">
        <div className="max-w-3xl">
          ...
          <div className="stagger-item opacity-0 inline-flex items-center gap-2 border border-[#E5E5E5] rounded-full px-4 py-2 text-sm font-medium text-[#666] mb-8">
            ...
            <span>متاح لفرص استشارية وقيادية مختارة</span>
          </div>
          ...
          <p className="stagger-item opacity-0 font-serif-display font-bold text-xl sm:text-2xl lg:text-3xl text-[#333] mb-6 leading-tight">
            قائد المنتجات وتحول الذكاء الاصطناعي
          </p>
          ...
          {/* Tags */}
          <div className="stagger-item opacity-0 flex flex-wrap gap-2 mb-10">
            {tags.map((tag) => (
              <a
                key={tag.label}
                href={tag.href}
                className="border border-[#E5E5E5] rounded-full px-4 py-1.5 text-sm font-medium hover:bg-[#F5F5F5] transition-colors min-h-[44px] flex items-center"
              >
                {tag.label}
              </a>
            ))}
