...
export default function AskAI() {
  ...
  return (
    <section id="ask-ai" className="py-20 lg:py-28 border-t border-[#E5E5E5] bg-[#FAFAFA]" aria-labelledby="ask-ai-heading">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-10">
          ...
          <p className="text-[#666] text-base leading-relaxed">
            إجابات مبنية على عملي وكتبي وتفكيري — وليس أوهاماً
          </p>
        </div>
